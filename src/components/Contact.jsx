    ...
    <section id="contact" className="section section--alt">
      <div className="wrapper">
        ...
        <p className="section-subtitle">
          Estoy abierto a nuevas oportunidades, colaboraciones o simplemente una buena conversación entre desarrolladores.
        </p>
        ...
        <div className="two-col">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <ContactLink
              icon={<LinkedInIcon />}
              label="LinkedIn"
              value="daniel-fernandez-fer24191"
              href={personalInfo.linkedin}
            />
            <ContactLink
              icon={<GitHubIcon />}
              label="GitHub"
              value="github.com/daniel-dev"
          ...
          <form
            onSubmit={e => {
              e.preventDefault()
              window.location.href = `mailto:${personalInfo.email}?subject=Contacto desde portfolio`
            }}
...
function ContactLink({ icon, label, value, href }) {
  return (
    ...
    >
      ...
      <div>
        <p style={{ fontFamily: 'var(--font-mono)', fontSize: '0.7rem', color: 'var(--color-text-dim)', marginBottom: '4px' }}>
          {label}
        </p>
        <p style={{ fontSize: '0.875rem', color: 'var(--color-text)' }}>{value}</p>
      </div>
    </a>
  )
}
